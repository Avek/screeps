...
*/
 ...
 /*
    ...
    logger.log("<h5><b><font color=\"lightblue\">"+ret+"</font></b></h5>");*/
    ...
    try {
        ...
        if(true){// Game.spawns.Spawn1 && Game.spawns.Spawn1.room.mode != MODE_SIMULATION) {
            if(Game.spawns.Spawn1){
                //eventSpawnUnitCL1.run(Game.spawns.Spawn1, 12, 0);
            ...
            logger.log("ASDFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF");
    ...
    }catch(e){logger.log("<b><font color=\"red\">"+"ERROR: "+e.stack+"</font>");}
    ...
    logger.log('Main has used '+elapsed+' CPU time, bucket contains: '+ Game.cpu.bucket );
